...
- threshold: The minimum similarity score required for a match to be considered valid. Default value is 0.5.
...
calculate_and_match <- function(input_segment, source_segments, threshold = 0.5) {
  #overall fuction working to check similarity and matching score
}
...
3.	Optionally, adjust the threshold value for similarity score.
